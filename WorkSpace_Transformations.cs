...
{
    internal class WorkSpace_Transformations
    {
        IWindow _window;
        GL _gl;
        ...
        public WorkSpace_Transformations()
        {
            // 创建窗口选项（使用默认配置）  
        ...
        public void OnLoad()
        {
            ...
            shader = new Shader(_gl, Shader.VertexShaderSource_Transformations, Shader.FragmentShaderSource_Transformations);
        ...
        public void OnRender(double obj)
        {
            ...
            unsafe
            {
                for (int i = 0; i < Transforms.Length; i++)
                {
                    ...
                    _gl.DrawElements(PrimitiveType.Triangles, (uint)GetVertice.GetIndices_Texture().Length, DrawElementsType.UnsignedInt, null);
                }
            }
