...
namespace WindowingView
{
    internal class WorkSpace_Quad
    {
        ...
        public void OnLoad()
        {
            ...
            // ---------- 定义顶点数据和索引数据 ----------
            float[] vertices = GetVertice.GetVertices_Quad();
            uint[] indices = GetVertice.GetIndices_Quad();
            ...
            shader = new Shader(_gl, Shader.VertexShaderSource_Quad, Shader.FragmentShaderSource_Quad);
        ...
        public void OnRender(double obj)
        {
            ...
            unsafe
            {
                _gl.DrawElements(PrimitiveType.Triangles,
                            (uint)GetVertice.GetIndices_Quad().Length,
